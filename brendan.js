...
$(document).ready(function() {
    ...
    function initialize() {
        ...
        var broadRipplePoly = new google.maps.Polyline({
        ...
        window.butlerPolygon = new google.maps.Polygon({
            paths: butlerCoords,
            strokeColor: '#92D300',
            strokeOpacity: 0.8,
            strokeWeight: 2,
...
/*
 Constructor
 ///////////////////////////////////////////
function MapItem (coords, stroke, strokeOpacity, weight, fill, fillOpacity, prev, next, type) {
    this.coords = coords;
    this.polyObj = new google.maps.Polygon({
        paths: coords,
        strokeColor: stroke,
